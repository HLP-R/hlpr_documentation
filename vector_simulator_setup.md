**Important Notice**: this is a condensed version of setup instructions. For details, refer to [Stanley wiki page for vector](https://github.com/StanleyInnovation/vector_v1/wiki/Setup-Instructions).
